...
class TrajectoryGeneratorComan: public RTT::TaskContext {
public:
    TrajectoryGeneratorComan(std::string const & name);
    ...
    void setObjectCenterLeft(double x, double y,double z);
    void setObjectCenterRight(double x, double y,double z);
    void displayStatus();
...
private:
    ...
    Eigen::Vector3f objectcenterLeft, objectcenterRight;
    float factor;
};
